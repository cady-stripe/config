# Generated by Powerlevel10k configuration wizard on 2021-02-11 at 11:39 PST.
...
# sharp heads, flat tails, 2 lines, solid, no frame, lightest-ornaments, compact,
...
() {
  ...
  typeset -g POWERLEVEL9K_CUSTOM_GET_CLIENT='_get_client'
  typeset -g POWERLEVEL9K_CUSTOM_GET_CLIENT_FOREGROUND='15'
  typeset -g POWERLEVEL9K_CUSTOM_GET_CLIENT_BACKGROUND='99'
  typeset -g POWERLEVEL9K_CUSTOM_GET_DIR='_get_Dir'

  # function prompt_github_pr() {
  #   branch=$(git branch --show-current 2> /dev/null) || return 0
  #   p10k segment -b 1 -f 3 -i '⭐' -t 'yoo, %n'
  #   # hub pr list -s open -h google:prr/$USER/$branch -f '%i%Creset [%pS]'
  # }

  function github_pr() {
    cd $2
    hub pr list -s all -h "$1" -f '%i %pS %sH'
  }
  ...
  async_stop_worker         my_async_worker
  async_start_worker        my_async_worker -u
  async_unregister_callback my_async_worker
  async_register_callback   my_async_worker github_pr_callback
  ...
  function prompt_github_pr() {
    ...
    async_job my_async_worker github_pr $branch $(pwd)
  }
